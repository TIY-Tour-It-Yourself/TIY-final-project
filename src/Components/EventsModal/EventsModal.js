...
const EventsModal = ({ handleCloseModal, handleEventSelection }) => {
  ...
  const handleEventClickInverse = (event) => {
    ...
    if (index !== -1) {
      setSelectedEvents(
        selectedEvents.slice(0, index).concat(selectedEvents.slice(index + 1))
      );
    }
  };
  ...
  const style = {
    ...
    width: isSmallScreen ? "80%" : "40%", // Adjust the width based on the screen size
    height: "75%",
    borderRadius: "30px",
          ...
          <div>
            <section className={styles.modal}>
              ...
              <div>
                ...
                >
                  <span>Scroll down to see events on specific dates</span>
                </Typography>
              </div>
                          ...
                          {selectedEvents
                            .sort((a, b) => {
                              ...
                              if (
                                ...
                                if (sortableEndDateA < sortableEndDateB)
                                  return -1;
                                if (sortableEndDateA > sortableEndDateB)
                                  return 1;
                              }
                            ...
                            .map((event, index) => (
                              <li
                                key={index}
                                onClick={() => handleEventClickInverse(event)}
                              ...
                              >
                                <p>
                                  <b>{event.title}</b> <br /> {event.location}
                                  <br />
                                  {event.address} <br />
                                  {event.date}
                                </p>
