...
//           // Display the first instruction in the div
...
//           // instructionDiv.innerHTML = `<b>${firstInstruction}</b> (${firstDistance}, ${firstDuration})`;
...
//               // console.log(stepEnd);
//               const { lat, lng } = stepStart;
//               const stepStartCoords = { lat, lng };
//               console.log(stepStart.lat_lng());
...
//                   directionsDiv.replaceChild(
//                     instructionDiv,
//                     directionsDiv.firstChild
//                   );
//                 }
//               }
//             },
