          ...
          {routes.map((route) => (
            ...
            >
              <div
                ...
                onClick={() => chooseRoute(route.routeid, route.description)}
              >
              ...
              <div className={styles.img_icons}>
                ...
                <div
                  ...
                  onClick={() =>
                    handleModifierForm(route.routeid, route.description)
                  }
                >
        ...
        <div className={styles.routes_imgs}>
          {filteredData.map((route) => (
            ...
            >
              <div
                className={styles.route_img}
                onClick={(e) => chooseRoute(route.routeid, route.description)}
              >
                <img src={route.imgurl} alt={route.description} />
              </div>
              <Typography
