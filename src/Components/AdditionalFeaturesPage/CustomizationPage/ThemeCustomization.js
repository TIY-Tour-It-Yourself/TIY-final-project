    ...
    <>
      {isLoading ? (
        ...
        <>
          ...
          >
            <h2
              className={styles.CustomizeTitle}
            >
              Customize Your App
            </h2>
          </Typography>
                ...
                return (
                  <Button
                    ...
                    style={{
                      ...
                      marginRight: "10px",
                      color:
                        selectedColor === color.code ? fontColor : "#00337C",
                      border:
                        selectedColor === color.code
                          ? "1px solid grey"
                          : "none",
                      ...(isSmallScreen ? { margin: "2%", width: "40%" } : {}),
                    }}
            ...
            {lockedColors.map((color, index) => (
              <Button
                ...
                style={{
                  backgroundColor: color.code,
                  marginRight: "10px",
                  color: selectedColor === color.code ? fontColor : "#00337C",
                  border:
                    selectedColor === color.code ? "1px solid grey" : "none",
                  ...(isSmallScreen ? { margin: "2%", width: "40%" } : {}),
                  ...(color.status === "Locked"
                    ? { backgroundColor: "#F0F0F0", color: "#7F8487" }
                    : {}),
                }}
                onClick={() => handleButtonClick(color.name, color.code)}
                  ...
                  >
                    {lockedColors.map((color, index) => (
                      <Button
                        ...
                        disabled={
                          !lockedColors.find(
                            (lockedColor) => lockedColor.code === color.code
                          )
                        }
                      >
                        {color.name}
