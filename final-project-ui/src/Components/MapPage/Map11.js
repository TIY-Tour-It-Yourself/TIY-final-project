...
const marker1= {
  lat: 32.08632988098686, 
  lng: 34.81831450580306
};
...
const Map11 = (props) => {
   ...
   async function calculateRoute() {
      ...
      const markers = [];
      const destinations = results.routes[0].legs.map(
        ...
        <div className="row">
         ...
         <div className='Map'>
            ...
            >
               ...
               <Marker position={marker1} onClick={handleOpenModal}></Marker>
{/* 
               <ReactModal
                  isOpen={showModal}
